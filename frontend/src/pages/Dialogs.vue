<template>
  <v-ons-page>
    ...
    >
      Lorem ipsum
      <v-ons-icon icon="fa-commenting-o"></v-ons-icon>
    </v-ons-alert-dialog>

    <v-ons-toast :visible="toastVisible" animation="fall">Supercalifragilisticexpialidocious
      <button @click="toastVisible = false">No way</button>
    </v-ons-toast>
    ...
    <v-ons-action-sheet :visible.sync="actionSheetVisible" cancelable>
      <v-ons-action-sheet-button @click="actionSheetVisible = false" icon="md-square-o">Action 1
      </v-ons-action-sheet-button>
      <v-ons-action-sheet-button @click="actionSheetVisible = false" icon="md-square-o">Action 2
      </v-ons-action-sheet-button>
      <v-ons-action-sheet-button @click="actionSheetVisible = false" modifier="destructive" icon="md-square-o">Action
        3
      </v-ons-action-sheet-button>
      <v-ons-action-sheet-button @click="actionSheetVisible = false" icon="md-square-o">Cancel
      </v-ons-action-sheet-button>
    </v-ons-action-sheet>
  </v-ons-page>
</template>
